...
public:
	...
	virtual glm::vec3 PhongShading(float, glm::vec3, glm::vec3, glm::vec3, float, Shape*[]) = 0;
	...
	glm::vec3 Reflections(glm::vec3 n,glm::vec3 RDireciton, glm::vec3 ContactPoint, Shape* ShapeArray[]);
};