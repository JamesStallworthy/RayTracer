...
Light light(glm::vec3(0,30,-10),1);
...
Shape* triangle = new Triangle(glm::vec3(0, 0, -5), glm::vec3(2, 0, -5), glm::vec3(1.5f, 1, -15), glm::vec3(1, 0, 0),0.1,10,&light);
Shape* ShapeArray[7];
...
int main(int argc, char *argv[]) {
	...
	clock_t t;
	t = clock();
	ray.RayCast(image, ShapeArray, 7);
	t = clock() - t;
